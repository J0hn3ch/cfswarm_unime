...
def log_init():
    ...
    lg_pos = LogConfigGen(name='Position', period_in_ms=20)
...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(uri, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        #ani = animation.FuncAnimation(fig, run, data_picker, interval=500, init_func=init, save_count=100)
        #ani = animation.FuncAnimation(fig, animate, interval=20, blit=True, save_count=50)
        #ani_t = animation.TimedAnimation(fig, interval=10, blit=True)
        ...
        #ani = animation.FuncAnimation(fig, func=partial(update_signal, signal=line), frames=None, event_source=logconf, blit=True, save_count=100)
        #plt.show(block=False)
        ...
        with SyncLogger(scf, logconf) as logger:
            ...
            while True:
                ...
                #line.set_data(next(t), log_entry[1].stateEstimate.y)
